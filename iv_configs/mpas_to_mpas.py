...
inGridFileName_path = '/usr/projects/climate/vankova/sg_files/'
...
outGridFileName_path = '/usr/projects/e3sm/inputdata/ocn/mpas-o/ECwISC30to60E2r1/'
...
outputFileName_path = f'{inGridFileName_path}remapped/'
